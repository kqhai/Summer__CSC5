...
int main(int argv, char** argc)
{
    ...
    // Declare Variables
    int dice1, dice2, dice3, rndSeed = pow(2, 3) - 1, rCount = 0, combo = 0;
    float pnts = 0, pnts2 = 0;
    char init;
    bool result = true, snglRoll = false, plyAgn = true;
    string initSen = "You're playing a game of Cee-Lo, to start the game type in Y to roll or N to Exit now";

    //file setup
    ofstream fName;
    fName.open("diceGame_Results.txt"); //opens and write in file
